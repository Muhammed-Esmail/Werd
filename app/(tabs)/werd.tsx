...
const TodayCard = ({ progress }: { progress: DailyProgress }) => {
  ...
  return (
    <View className='bg-white dark:bg-surfaceBlack border-[1px] border-gray-200 dark:border-mutedWhite rounded-[20px]'>
      ...
      <TouchableOpacity activeOpacity={0.7} className='mt-5 h-15 p-4 bg-goldMuted dark:bg-mutedBlack border-[1px] border-gray-300 dark:border-light-300 rounded-2xl w-[80%] items-center justify-center self-center mb-7'>
